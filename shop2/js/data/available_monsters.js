...
eachoa(available_monsters, function(monster_id, monster_info){
	monster_info['power'] *= 0.1;
	monster_info['health'] *= 4;
	var mob_value = 0;
	...
	var loot_value = 0;
	eachoa(monster_info['loot'], function(loot_id, loot_chance){
