function parse_monster(monster_id, monster_amount, monster_health_percent, current_id, show_entry, unique_monster_id){
	var parsed_item = '';
	if(available_monsters[monster_id] != undefined)
	{
		...
		parsed_item +=				'<div class="item show_entry_' + show_entry + ' item_container_' + unique_monster_id + ' item_container_' + unique_monster_id + '_' + current_id + ' rarity_' + rarity + '" style="background-image:url(images/' + available_monsters[monster_id]['image'] + ');">';
...
function parse_unit(monster_id, monster_amount, monster_health_percent){
	...
	if(available_items[monster_id] != undefined)
	{
		...
		parsed_item +=				'<div class="item item_container_c_' + monster_id + ' rarity_' + rarity + '" style="background-image:url(images/' + available_items[monster_id]['image'] + ');">';
		parsed_item += 					'<div class="monster_health_bar_container"><div class="monster_health_bar" style="width:' + monster_health_percent + '%"></div></div>';
...
function show_item_stats(item_id){
	...
	if(available_items[item_id] != undefined && available_items[item_id]['stats'] != undefined)
	{
		...
		eachoa(current_stats['abilities'], function(ability_id, ability_level){
